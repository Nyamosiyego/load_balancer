...
def hash_request(request_id):
    ...
    hash_value = hashlib.sha256(request_id_bytes).hexdigest()
...
def hash_virtual_server(server_id, virtual_server_id):
    ...
    virtual_server_id_bytes = str(virtual_server_id).encode('utf-8')
    combined_bytes = server_id_bytes + virtual_server_id_bytes
